    ...
    try:
        for e in range(args.epochs):
            ...
            for batch_index, (data, label) in enumerate(train_iterator):
                ...
                if args.con == 'CBCL':
                    loss_cbcl = criterion_cbcl(output_proxy, feat_mlp, diagnosis_label, 1 - accuracy_per_class_global)

                
                loss = alpha * loss_ce + beta * loss_cbcl
                loss.backward()
...
parser.add_argument('--E1', type=int, default=20, choices=[10, 20, 30, 40, 50, 60, 70, 80, 90],help='hyperparameter for ce loss')
parser.add_argument('--E2', type=int, default=70, choices=[10, 20, 30, 40, 50, 60, 70, 80, 90],help='hyperparameter for ce loss')
