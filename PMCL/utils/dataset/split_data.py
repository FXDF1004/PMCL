...
from project_utils import mkdir_if_not_exist,traverse_dir_files
import os
import shutil
import csv
import random
...
parser.add_argument('--datapath',default='/home/xl/thinclient_drives/xd/Awesome-Backbones-main/skin_cancer2019/dataset',type=str,help='the path of dataset')
